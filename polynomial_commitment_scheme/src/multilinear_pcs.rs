...
impl<F: PrimeField + Borrow<Fp<MontBackend<FrConfig, 4>, 4>>> TrustedSetup<F> {
    ...
    */
    ...
    pub fn commit_to_polynomial(self, multilinear: MultilinearPoly<F>) -> G1 {
        ...
        let poly = multilinear.polynomial;
        ...
        self.evaluate_with_lagrange_basis(&poly)
    }
...
mod tests {
    ...
    fn test_verify() {
        ...
        let commitment = trusted_setup.clone().commit_to_polynomial(poly.clone());
        ...
        let proof = trusted_setup.clone().open_polynomial(poly, a);
